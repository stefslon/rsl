...
static int vcp35[38]={35,514,91,64,3616,91,0,11531,164,64,3616,164,0,11531,237,64,3985,237,0,11531,328,3,11279,437,3,12930,564,5,12325,728,5,13157,928,5,13157,1165,5,13157};
 ...
 */
    ...
    case 32:
      ...
      break;    
    case 35:
      fix_angle =   vcp35[(3*el_num)-1];
      pulse_cnt =   vcp35[(3*el_num)];
      az_rate =     vcp35[(3*el_num)+1];
      pulse_width = vcp35[1];
      break;
    case 300:
